---
title: Apple Development Official Skill Manifest
---
...
- `xcode_build`: `17E201`
- `ide_intelligencechat_version`: `24899.2`
- `ide_intelligencechat_source_version`: `24899002000000000`
- `claude_version`: `2.1.59`
- `codex_version`: `0.106.0`
- `install_path`: `SKILL_ROOT`
- `symlink_path`: `CODEX_HOME/skills/apple-development-official`
